...
(function (powerbi) {
    var visuals;
    (function (visuals) {
        var DonutChartGMO1461469098694;
        (function (DonutChartGMO1461469098694) {
            ...
            var GMOSVGLegend = (function () {
                ...
                GMOSVGLegend.prototype.drawLegendInternal = function (data, viewport, autoWidth, detailedLegend) {
                    ...
                    if (data.dataPoints.length === 0) {
                        this.changeOrientation(visuals.LegendPosition.Top);
                    }
            ...
            DonutChartGMO1461469098694.GMOSVGLegend = GMOSVGLegend;
            DonutChartGMO1461469098694.DonutChartGMOProperties = {
                general: {
                ...
                summaryLabels: {
                    show: { objectName: 'summaryLabels', propertyName: 'show' },
                    color: { objectName: 'summaryLabels', propertyName: 'color' },
                    labelDisplayUnits: { objectName: 'summaryLabels', propertyName: 'labelDisplayUnits' },
                    labelPrecision: { objectName: 'summaryLabels', propertyName: 'labelPrecision' },
                    fontSize: { objectName: 'summaryLabels', propertyName: 'fontSize' },
                    primaryMeasureSummaryText: { objectName: 'summaryLabels', propertyName: 'primaryMeasureSummaryText' },
                },
            ...
            ;
            DonutChartGMO1461469098694.detailedLegendType = powerbi.createEnumType([
            ...
            DonutChartGMO1461469098694.DonutChartInteractiveLegend = DonutChartInteractiveLegend;
                    ...
                    function DonutChartConverter(dataView, colors, defaultDataPointColor) {
                        ...
                        for (var seriesIndex = 0; seriesIndex < this.seriesCount; seriesIndex++) {
                            ...
                            for (var measureIndex = 0; measureIndex < seriesData.values.length; measureIndex++) {
                                localSum += Math.abs(parseFloat(seriesData.values[measureIndex] ? seriesData.values[measureIndex].toString() : '0'));
                                this.total += Math.abs(parseFloat(seriesData.values[measureIndex] ? seriesData.values[measureIndex].toString() : '0'));
                                this.highlightTotal += this.hasHighlights ? Math.abs(parseFloat(seriesData.highlights[measureIndex] ? seriesData.highlights[measureIndex].toString() : '0')) : 0;
                            }
                    ...
                    DonutChartConverter.prototype.convert = function () {
                        ...
                        for (var i = 0, dataPointCount = convertedData.length; i < dataPointCount; i++) {
                            ...
                            if (this.secondaryMeasureIndex !== -1) {
                                if (isNaN(parseInt(this.dataViewCategorical.values[this.secondaryMeasureIndex].values[i] ? this.dataViewCategorical.values[this.secondaryMeasureIndex].values[i].toString() : null, 10))) {
                        ...
                        for (var i = 0; i < this.legendDataPoints.length; i++) {
                            if (parseFloat(this.legendDataPoints[i]['measureTooltip']) < 0) {
                                this.legendDataPoints.splice(i, 1);
                                --i;
                            }
                        }
                            ...
                            for (var seriesIndex = 0; seriesIndex < this.seriesCount; seriesIndex++) {
                                ...
                                var dataPoint = {
                                    ...
                                    measureValue: {
                                        ...
                                        value: Math.abs(parseFloat(nonHighlight ? nonHighlight.toString() : '0')),
                                    },
                                    highlightMeasureValue: {
                                        measure: highlight,
                                        value: Math.abs(parseFloat(highlight ? highlight.toString() : '0')),
                                    },
            ...
            var DonutChartGMO = (function () {
                ...
                DonutChartGMO.prototype.update = function (options) {
                    ...
                    var summaryLabelsSettings = this.getSummaryLabelsSettings(this.dataViews[0]);
                    this.detailLabelsTextSize = summaryLabelsSettings.fontSize;
                    this.detailLabelsDecimalPlaces = summaryLabelsSettings.labelPrecision;
                    if (this.detailLabelsDecimalPlaces > 20) {
                        this.detailLabelsDecimalPlaces = 20;
                    }
                    this.detailLabelsColor = summaryLabelsSettings.color;
                    this.detailLabelsDisplayUnits = summaryLabelsSettings.labelDisplayUnits;
                    this.detailLabelsShowSummary = summaryLabelsSettings.show;
                    this.primaryMeasureSummaryText = summaryLabelsSettings.primaryMeasureSummaryText;
                    /*
        ...
        */
                    ...
                    switch (options.objectName) {
                        ...
                        case 'summaryLabels':
                            enumeration.pushInstance({
                                objectName: 'summaryLabels',
                                displayName: 'Summary Labels',
                                selector: null,
                                properties: {
                                    show: summaryLabelsSettings.show,
                                    color: summaryLabelsSettings.color,
                                    labelDisplayUnits: summaryLabelsSettings.labelDisplayUnits,
                                    labelPrecision: summaryLabelsSettings.labelPrecision,
                                    fontSize: summaryLabelsSettings.fontSize,
                                    primaryMeasureSummaryText: summaryLabelsSettings.primaryMeasureSummaryText
                                }
                            });
                            break;
                        case 'GMODonutTitle':
                ...
                DonutChartGMO.prototype.getStatus = function (dataView, text, category) {
                    if (dataView && dataView.metadata && dataView.metadata.objects) {
                        if (dataView.metadata.objects && dataView.metadata.objects.hasOwnProperty(category)) {
                            var showTitle = dataView.metadata.objects[category];
                            if (dataView.metadata.objects && showTitle.hasOwnProperty(text)) {
                                return parseFloat(showTitle[text] ? showTitle[text].toString() : '0');
                            }
                        }
                        else {
                            return 0;
                ...
                DonutChartGMO.prototype.getSummaryLabelsSettings = function (dataView) {
                    var objects = null;
                    var summaryLabelsSetting = this.getDefaultSummaryLabelsSettings();
                    if (!dataView.metadata || !dataView.metadata.objects)
                        return summaryLabelsSetting;
                    objects = dataView.metadata.objects;
                    var summaryLabelsProperties = DonutChartGMO1461469098694.DonutChartGMOProperties;
                    summaryLabelsSetting.show = powerbi.DataViewObjects.getValue(objects, summaryLabelsProperties.summaryLabels.show, summaryLabelsSetting.show);
                    summaryLabelsSetting.color = powerbi.DataViewObjects.getFillColor(objects, summaryLabelsProperties.summaryLabels.color, summaryLabelsSetting.color);
                    summaryLabelsSetting.labelDisplayUnits = powerbi.DataViewObjects.getValue(objects, summaryLabelsProperties.summaryLabels.labelDisplayUnits, summaryLabelsSetting.labelDisplayUnits);
                    summaryLabelsSetting.labelPrecision = powerbi.DataViewObjects.getValue(objects, summaryLabelsProperties.summaryLabels.labelPrecision, summaryLabelsSetting.labelPrecision);
                    summaryLabelsSetting.fontSize = powerbi.DataViewObjects.getValue(objects, summaryLabelsProperties.summaryLabels.fontSize, summaryLabelsSetting.fontSize);
                    summaryLabelsSetting.primaryMeasureSummaryText = powerbi.DataViewObjects.getValue(objects, summaryLabelsProperties.summaryLabels.primaryMeasureSummaryText, summaryLabelsSetting.primaryMeasureSummaryText);
                    return summaryLabelsSetting;
                };
                DonutChartGMO.prototype.getDefaultSummaryLabelsSettings = function () {
                    return {
                        show: true,
                        color: '#777777',
                        labelDisplayUnits: 0,
                        labelPrecision: 0,
                        fontSize: 12,
                        primaryMeasureSummaryText: 'Total'
                    };
                };
                ...
                DonutChartGMO.prototype.getTitleFill = function (dataView) {
                    if (dataView && dataView.metadata && dataView.metadata.objects) {
                        if (dataView.metadata.objects && dataView.metadata.objects.hasOwnProperty('GMODonutTitle')) {
                            ...
                            return dataView && dataView.metadata && powerbi.DataViewObjects.getValue(dataView.metadata.objects, DonutChartGMO1461469098694.DonutChartGMOProperties.titleFill, { solid: { color: '#333333' } });
                        }
                    }
                    return dataView && dataView.metadata && powerbi.DataViewObjects.getValue(dataView.metadata.objects, DonutChartGMO1461469098694.DonutChartGMOProperties.titleFill, { solid: { color: '#333333' } });
                };
                ...
                DonutChartGMO.prototype.getTitleBgcolor = function (dataView) {
                    if (dataView && dataView.metadata && dataView.metadata.objects) {
                        if (dataView.metadata.objects && dataView.metadata.objects.hasOwnProperty('GMODonutTitle')) {
                            ...
                            return dataView && dataView.metadata && powerbi.DataViewObjects.getValue(dataView.metadata.objects, DonutChartGMO1461469098694.DonutChartGMOProperties.titleBackgroundColor, { solid: { color: 'none' } });
                        }
                    }
                    return dataView && dataView.metadata && powerbi.DataViewObjects.getValue(dataView.metadata.objects, DonutChartGMO1461469098694.DonutChartGMOProperties.titleBackgroundColor, { solid: { color: 'none' } });
                };
                ...
                DonutChartGMO.prototype.createLabelDataPoint = function (d, alternativeScale, measureFormatterCache) {
                    ...
                    if (labelSettingsStyle === "Both" || labelSettingsStyle === visuals.labelStyle.data) {
                        dataLabel = measureFormatter.format(d.data.measure);
                        dataLabelSize = this.getTextSize(dataLabel, fontSize);
                    }
                    if (labelSettingsStyle === "Both" || labelSettingsStyle === visuals.labelStyle.category) {
                    ...
                    objects: {
                        ...
                        legend: {
                            ...
                            properties: {
                                ...
                                detailedLegend: {
                                    ...
                                    type: { enumeration: DonutChartGMO1461469098694.detailedLegendType },
                                    suppressFormatPainterCopy: true
                                },
                                labelDisplayUnits: {
                        ...
                        summaryLabels: {
                            ...
                            properties: {
                                ...
                                color: {
                                    displayName: 'Color',
                                    description: 'Select color for summary labels',
                                    type: { fill: { solid: { color: true } } }
                                },
                                labelDisplayUnits: {
                                    displayName: 'Display Units',
            ...
            DonutChartGMO1461469098694.DonutChartGMO = DonutChartGMO;
        })(DonutChartGMO1461469098694 = visuals.DonutChartGMO1461469098694 || (visuals.DonutChartGMO1461469098694 = {}));
...
(function (powerbi) {
    ...
    (function (visuals) {
        var plugins;
        (function (plugins) {
            plugins.DonutChartGMO1461469098694 = {
                name: 'DonutChartGMO1461469098694',
                class: 'DonutChartGMO1461469098694',
                capabilities: powerbi.visuals.DonutChartGMO1461469098694.DonutChartGMO.capabilities,
                custom: true,
                create: function (options) { return new powerbi.visuals.DonutChartGMO1461469098694.DonutChartGMO(options); },
                apiVersion: null
            };
